...
class Cheat(MakefilePackage):
    ...
    WIP
     20    # [github.com/cheat/cheat/cmd/cheat]
  >> 21    vet: cmd/cheat/cmd_init.go:33:13: undefined: configs
  >> 22    make: *** [Makefile:181: vet] Error 1
     23    make: *** Waiting for unfinished jobs....
     24    go: downloading github.com/go-git/go-billy/v5 v5.5.0
     25    go: downloading github.com/go-git/gcfg v1.5.1-0.20230307220236-3a3c6141e376
     26    go: downloading dario.cat/mergo v1.0.0
     27    go: downloading github.com/pjbgf/sha1cd v0.3.0
     28    go: downloading github.com/emirpasic/gods v1.18.1

See build log for details:
  /tmp/accopeland/spack-stage/spack-stage-cheat-4.4.2-36qusaxraxgkquwub7cgqajuysl2uden/spack-build-out.txt

==> Error: Could not remove prefix /clusterfs/jgi/groups/gentech/genome_analysis/spack-fork/spack/opt/spack/linux-rocky8-zen2/gcc-14.2.0/cheat-4.4.2-36qusaxraxgkquwub7cgqajuysl2uden for cheat@4.4.2%gcc@14.2.0 build_system=makefile arch=linux-rocky8-zen2/36qusax : [Errno 13] Permission denied: '.deepsource.toml
'
    ...
    conflicts("go", msg="WIP go vet errors")
    depends_on("go@1.22:", type="build")
    #depends_on("revive", type="build")
